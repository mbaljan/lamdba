...
?>
                    ...
                    <div class="section-header">
                        <?php
                            if( !empty($parallax_one_happy_customers_title) ){
                                echo '<h2 class="dark-text limit-size-heading">'.esc_attr($parallax_one_happy_customers_title).'</h2><div class="colored-line"></div>';
                ...
                if(!empty($parallax_one_testimonials_content)) {
                    ...
                    $ind = 0;
                        foreach($parallax_one_testimonials_content_decoded as $parallax_one_testimonial) {
                            if( !empty($parallax_one_testimonial->image_url) || !empty($parallax_one_testimonial->title) || !empty($parallax_one_testimonial->subtitle) || !empty($parallax_one_testimonial->text) && $ind < 6 ) {
                            $ind++;
                        ?>
                                <!-- SINGLE FEEDBACK -->
    ...
    <div class="fadeout"></div>
                <a href="#"> Weitere Teammitglieder</a>
            </div>
        </div>
    </section><!-- customers -->
<?php
